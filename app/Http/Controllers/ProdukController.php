...
class ProdukController extends Controller
{
    ...
    public function destroy(Produk $produk)
    {
        ...
        // Pengecekan agar tidak terjadi error foreign key constraint
        if (DB::table('item_penjualan')->where('produk_id', $produk->id)->exists()) {
            return redirect()->route('produk.index')->with('error', 'Produk tidak dapat dihapus karena masih memiliki riwayat transaksi.');
        }
