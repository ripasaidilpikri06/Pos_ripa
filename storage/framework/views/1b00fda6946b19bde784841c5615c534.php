                    ...
                    <div class="table-responsive cart-wrapper mb-3">
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $sale?->itemPenjualan
                                    ?? $sale?->details
                                    ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="small cart-price">
                                            ...
                                            Rp
                                            <?php echo e(number_format($item->harga_satuan, 0, ',', '.')); ?>
                    ...
                    <?php if($sale): ?>
                        ...
                        >
                            ...
                            >
                                ...
                                <option
                                    value="CASH"
                                    <?php echo e($sale->metode_pembayaran === 'CASH' ? 'selected' : ''); ?>
                                ...
                                <option
                                    value="QRIS"
                                    <?php echo e($sale->metode_pembayaran === 'QRIS' ? 'selected' : ''); ?>
                                ...
                                <option
                                    value="TRANSFER"
                                    <?php echo e($sale->metode_pembayaran === 'TRANSFER' ? 'selected' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\masrip\resources\views/penjualan/pos.blade.php ENDPATH**/ ?>