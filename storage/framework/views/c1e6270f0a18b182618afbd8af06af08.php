        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card dashboard-card stat-card primary h-100 p-3 position-relative">
                <div class="card-body p-2 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <h3 class="fw-bold text-white mb-0">Rp <?php echo e(number_format($ringkasan['total_penjualan'], 0, ',', '.')); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card dashboard-card stat-card success h-100 p-3 position-relative">
                <div class="card-body p-2 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <h3 class="fw-bold text-white mb-0"><?php echo e(number_format($ringkasan['total_transaksi'], 0, ',', '.')); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card dashboard-card h-100 p-3">
                <div class="card-body p-2 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <h4 class="fw-bold text-white mb-0">Rp <?php echo e(number_format($ringkasan['total_cash'], 0, ',', '.')); ?></h4>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card dashboard-card h-100 p-3">
                <div class="card-body p-2 d-flex flex-column justify-content-between">
                    ...
                    <div class="mt-3">
                        <h4 class="fw-bold text-white mb-0">Rp <?php echo e(number_format($ringkasan['total_non_tunai'], 0, ',', '.')); ?></h4>
                        ...
                        <table class="table table-custom align-middle">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $produkStokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-light fw-medium"><?php echo e($produkStokRendah->firstItem() + $index); ?></td>
                                        <td class="fw-bold text-white"><?php echo e($produk->nama); ?></td>
                                        <td class="text-end">
                        ...
                        <table class="table table-custom align-middle">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $produkStokHabis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-light fw-medium"><?php echo e($produkStokHabis->firstItem() + $index); ?></td>
                                        <td class="fw-bold text-white"><?php echo e($produk->nama); ?></td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <?php endif; ?>
                                                <span class="fw-bold text-white d-block"><?php echo e($produk->nama); ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            <span class="badge <?php echo e($loop->first ? 'bg-warning text-dark' : 'badge-soft-success'); ?> rounded-pill px-3 py-1 fw-semibold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Pos_ripa\resources\views/dashboard.blade.php ENDPATH**/ ?>